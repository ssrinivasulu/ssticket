...
(function () {
    ...
    TopicHelpers.ThumbPopup_Click = function (e) {
        var popupEl = TopicHelpers.ShowThumbnailPopup(e, this, "click");
    ...
    TopicHelpers.ThumbPopup_Hover = function (e) {
        var popupEl = TopicHelpers.ShowThumbnailPopup(e, this, "mouseleave");
    };

    TopicHelpers.ShowThumbnailPopup = function (e, aEl, showType) {
    ...
    TopicHelpers.Hyperlink_Onclick = function (e) {
        ...
        if (IsEmbeddedTopic()) {
            ...
            else if (MadCap.String.Contains(href, "javascript")) {
                return;
            }
            else {
    ...
    function HighlightSearchTerms() {
        ...
        MadCap.Utilities.CrossFrame.PostMessageRequest(parent, "get-href", null, function (data) {
            if (data) {
                ...
                for (var term = 0; term < terms.length; term++) {
                    if ($.inArray(terms[term].toLowerCase(), stopWords) != -1) {
                        terms.splice(term, 1);
                        term--;
                    }
                }
